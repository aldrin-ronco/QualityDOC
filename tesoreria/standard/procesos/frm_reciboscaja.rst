...
Use **ESC** para salir de las interfaces principales.
	...
	Use esta operación para registrar los ingresos en un centro de costo por motivo de *Recaudos de cartera* (Abono de venta a crédito) o *Recaudos por conceptos* (Anticipos de clientes, intereses, pago de préstamos a terceros, etc).
