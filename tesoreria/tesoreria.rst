...
---------------------------------
  ...
  `Tesorería <../tesoreria/procesos.html>`_


  Lleve a cabo: recibos de caja, comprobantes de egresos, notas bancarias, transferencias de fondos, relación de gastos, préstamos y además consultas sobre los movimientos efectuados.
